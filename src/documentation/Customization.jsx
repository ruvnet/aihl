...
const Customization = () => (
  <Card>
    ...
    <CardContent>
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2">Extending the AI Judging System</h3>
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2">User Experience Customization</h3>
