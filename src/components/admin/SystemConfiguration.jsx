...
import { Settings, Bell, Globe, Bot, Github } from 'lucide-react';
...
const SystemConfiguration = () => {
  return (
    <div>
      ...
      <p className="text-gray-600 mb-4">Manage system settings, notifications, localization, LLM settings, and GitHub configuration.</p>
